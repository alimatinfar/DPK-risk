...
import setSeparator from "../../../../utils/inputOperations/setSeparator.ts";
import inputOnKeyDownJustNumber from "../../../../utils/inputOperations/inputOnKeyDownJustNumber.ts";
import onInputJustUpperCaseEnglish from "../../../../utils/inputOperations/onInputJustUpperCaseEnglish.ts";
import onInputJustEnglishLetters from "../../../../utils/inputOperations/onInputJustEnglishLetters.ts";
import onInputUpperCaseEnglish from "../../../../utils/inputOperations/onInputUpperCaseEnglish.ts";
import onInputLimitedDecimals from "../../../../utils/inputOperations/onInputLimitedDecimals.ts";
...
function useInput(
  {
    ...
    upperCaseEnglish, autoCompleteNewPassword
  }: Props
) {
  ...
  const inputProps = {
    ...
    ...(value != null ? {value} : {}),
    ...((autoCompleteOff || autoCompleteNewPassword) && {autoComplete: autoCompleteNewPassword ? "new-password" : "off"}),
