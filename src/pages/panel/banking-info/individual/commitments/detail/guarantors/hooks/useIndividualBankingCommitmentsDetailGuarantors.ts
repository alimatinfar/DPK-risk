import {
  PANEL_INDIVIDUAL_COMMITMENT_DETAIL_TABLE_COLUMNS_KEYS
...
function useIndividualBankingCommitmentsDetailGuarantors() {
...
export default useIndividualBankingCommitmentsDetailGuarantors;
