...
import {INDIRECT_COMMITMENT_KEYS, PANEL_INDIVIDUAL_COMMITMENTS_TABLE_COLUMNS_KEYS} from "../index.constances.tsx";
...
function usePanelIndividualBankingInfoCommitments() {
...
export default usePanelIndividualBankingInfoCommitments;
