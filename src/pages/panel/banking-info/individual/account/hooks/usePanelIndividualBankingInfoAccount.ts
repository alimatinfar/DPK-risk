...
import {PANEL_INDIVIDUAL_BANK_INFO_ACCOUNT_TABLE_COLUMNS_KEYS} from "../index.constances.tsx";
...
function usePanelIndividualBankingInfoAccount() {
...
export default usePanelIndividualBankingInfoAccount;
