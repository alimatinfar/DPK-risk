...
export const PANEL_TRANSACTION_HISTORY_E_SERVICE_TABLE_COLUMNS: TableColumnType[] = [
  ...
  {
    label: 'تعداد تراکنش',
    accessor: PANEL_TRANSACTION_HISTORY_E_SERVICE_TABLE_COLUMNS_KEYS.TRANSACTION_COUNT,
  },
  {
    label: 'مجموع بستانکار',
    accessor: PANEL_TRANSACTION_HISTORY_E_SERVICE_TABLE_COLUMNS_KEYS.TOTAL_CREDITOR,
  },
  {
    label: 'مجموع بدهکار',
    accessor: PANEL_TRANSACTION_HISTORY_E_SERVICE_TABLE_COLUMNS_KEYS.TOTAL_DEBTOR,
  },
  {
    label: 'مجموع بستانکار - مجموع بدهکار',
    accessor: PANEL_TRANSACTION_HISTORY_E_SERVICE_TABLE_COLUMNS_KEYS.BALANCE,
  },
  ACTIONS_COLUMN
];
...
export const PANEL_TRANSACTION_HISTORY_E_SERVICE_TABLE_FAKE_DATA = getLast13Months().map((item, index) => ({
  ...
  [PANEL_TRANSACTION_HISTORY_E_SERVICE_TABLE_COLUMNS_KEYS.BALANCE]: '430,000,000',
}))
