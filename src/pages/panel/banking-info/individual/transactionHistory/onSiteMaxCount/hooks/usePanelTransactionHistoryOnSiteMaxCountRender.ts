...
} from "../PanelTransactionHistoryOnSiteMaxCountRender.tsx";

function usePanelTransactionHistoryOnSiteMaxCountRender(
...
export default usePanelTransactionHistoryOnSiteMaxCountRender;
