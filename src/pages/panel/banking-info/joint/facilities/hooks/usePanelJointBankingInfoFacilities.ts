...
import {PANEL_JOINT_FACILITIES_TABLE_COLUMNS_KEYS} from "../index.constances.tsx";
import withSeparator from "../../../../../../utils/separator/withSeparator.ts";
import displayDate from "../../../../../../utils/display/displayDate.ts";

function usePanelJointBankingInfoFacilities() {
...
export default usePanelJointBankingInfoFacilities;
