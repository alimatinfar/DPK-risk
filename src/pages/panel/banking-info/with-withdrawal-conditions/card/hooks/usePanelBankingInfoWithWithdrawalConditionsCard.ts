...
import type {PanelBankingInfoWithWithdrawalConditionsCardResponseType} from "../index.types.ts";
import APIS from "../../../../../../request/constances/apis.ts";
import {useMemo} from "react";
import {PANEL_INDIVIDUAL_CARD_INFO_TABLE_COLUMNS_KEYS} from "../../../individual/card/index.constances.tsx";
import displayDate from "../../../../../../utils/display/displayDate.ts";
import useFetchData from "../../../../../../request/hooks/useFetchData.ts";


function usePanelBankingInfoWithWithdrawalConditionsCard() {
...
export default usePanelBankingInfoWithWithdrawalConditionsCard;
