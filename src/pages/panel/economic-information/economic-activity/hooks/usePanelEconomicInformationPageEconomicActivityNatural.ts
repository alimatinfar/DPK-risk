...
function usePanelEconomicInformationPageEconomicActivityNatural() {
  ...
  const naturalTableData = useMemo(function () {
    ...
    return data?.data?.map((item, index) => (    {
      ...
      [PANEL_ECONOMIC_ACTIVITY_INFORMATION_TABLE_COLUMNS_KEYS.EMPLOYMENT_START_DATE]: displayDate(item?.workStartDate),
      ...
      [PANEL_ECONOMIC_ACTIVITY_INFORMATION_TABLE_COLUMNS_KEYS.REGISTRATION_DATE]: displayDate(item?.registrationDate),
      ...
      [PANEL_ECONOMIC_ACTIVITY_INFORMATION_TABLE_COLUMNS_KEYS.LICENSE_ISSUE_DATE]: displayDate(item?.licenseIssuanceDate),
      [PANEL_ECONOMIC_ACTIVITY_INFORMATION_TABLE_COLUMNS_KEYS.LICENSE_EXPIRATION_ISSUE_DATE]: displayDate(item?.licenseExpirationDate),
      [PANEL_ECONOMIC_ACTIVITY_INFORMATION_TABLE_COLUMNS_KEYS.DECLARATION_DATE]: displayDate(item?.announcementDate),
      [PANEL_ECONOMIC_ACTIVITY_INFORMATION_TABLE_COLUMNS_KEYS.FROM_DATE]: displayDate(item?.fromDate),
    }))
