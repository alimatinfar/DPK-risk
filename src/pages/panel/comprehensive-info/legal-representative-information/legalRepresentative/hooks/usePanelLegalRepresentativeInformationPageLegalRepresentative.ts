...
import {PANEL_LEGAL_REPRESENTATIVE_TABLE_COLUMNS_KEYS} from "../index.constances.ts";
import displayDate from "../../../../../../utils/display/displayDate.ts";
import {useMemo} from "react";


function usePanelLegalRepresentativeInformationPageLegalRepresentative() {
  ...
  const tableData = useMemo(function () {
    ...
    return data?.data?.map((item, index) => ({
      ...
      [PANEL_LEGAL_REPRESENTATIVE_TABLE_COLUMNS_KEYS.NATIONALITY]: item?.nationalityTitle,
...
export default usePanelLegalRepresentativeInformationPageLegalRepresentative;
